...
public class AlbumView_Wifi extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(resultCode == RESULT_OK){
            ...
            new UploadFileTask(AlbumView_Wifi.this, DropboxClientFactory.getClient(), new UploadFileTask.Callback(){
                 @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (option.equals("Add User")) {
            AlertDialog.Builder builder = new AlertDialog.Builder(AlbumView_Wifi.this);
            builder.setTitle("Username To Add");

            final EditText input = new EditText(AlbumView_Wifi.this);
    ...
    public void urlParser(String usersString, JSONObject mapResponse){
        ...
        new DownloadFileTask(AlbumView_Wifi.this, DropboxClientFactory.getClient(), new DownloadFileTask.Callback(){
            @Override
